...
In order to support loading of multiple wallets in eulo-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is eulo.cpp.
...
Changes to eulo.cpp
----------------------
eulo.cpp is the entry point into eulo-qt, and as such, will require some minor modifications to provide hooks for
