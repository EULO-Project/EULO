PACKAGE=qt
$(package)_version=5.10.1
$(package)_download_path=http://download.qt.io/archive/qt/5.10/5.10.1/submodules/
...
#  cp -f $($(package)_patch_dir)/aarch64-qmake.conf qtbase/mkspecs/aarch64-linux-gnu/qmake.conf &&\
  ...
  FOO:= $(warning "_ldflags" $($(package)_ldflags)  $($(package)_cxxflags) )
endef
