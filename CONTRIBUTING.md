Contributing to EULO Core
============================

The EULO Core project operates an open contributor model where anyone is
...
The following applies to code changes to the EULO Core project, and is not to be
confused with overall EULO Network Protocol consensus changes.

Whether a pull request is merged into EULO Core rests with the project merge
...
Patches that change EULO consensus rules are considerably more involved than
...
Where a patch set proposes to change the EULO consensus, it must have been
...
The project leader is the release manager for each EULO Core release.
