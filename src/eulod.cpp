 ...
 *
 * This is the developer documentation of the reference client for an experimental new digital currency called EULO (http://www.eulo.org),
 * which enables instant payments to anyone, anywhere in the world. EULO uses peer-to-peer technology to operate
