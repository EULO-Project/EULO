...
#include "genesis/euloMainNetwork.cpp"
...
#include "genesis/test/euloTestNetwork.cpp"
...
std::string const& dev::eth::genesisInfo(Network _n)
{
    ...
    {
    //Client genesis
    case Network::euloMainNetwork: return c_genesisInfoEuloMainNetwork;
    case Network::MainNetwork: return c_genesisInfoMainNetwork;
    case Network::Ropsten: return c_genesisInfoRopsten;

    //Test genesis
    case Network::euloTestNetwork: return c_genesisInfoEuloTestNetwork;
...
h256 const& dev::eth::genesisStateRoot(Network _n)
{
    switch (_n)
    {
    case Network::euloMainNetwork: return c_genesisStateRootEuloMainNetwork;
    case Network::euloTestNetwork: return c_genesisStateRootEuloTestNetwork;
