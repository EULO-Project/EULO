...
#include <libevm/interpreter.h>

#include <libevm/loader.h>
...
//FixMe: comment this function as it is not used anywhere, Check if a bad move .
...
{
    //FixMe: comment these lines as it is not used anywhere, Check if a bad move .
//    switch (_kind)
//    {
//#ifdef ETH_EVMJIT
//    case VMKind::JIT:
