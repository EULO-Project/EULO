                                                    ...
                                                    transactionView(0)
{
    ...
    typeWidget->addItem(tr("Received Ulo from zUlo"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zUlo"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zUlo));
