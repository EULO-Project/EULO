...
void BitcoinApplication::createTrayIcon()
{
    ...
    QString toolTip = tr("EULO Core client");
...
{
    QMessageBox::critical(0, "Runaway exception", ("A fatal error occurred. EULO can no longer continue safely and will quit.") + QString("\n\n") + message);
    ::exit(1);
}
