...
//    }
    ...
    style: Controls_Style_1.TextFieldStyle{
        background: Rectangle{
            color: (backgroundColor == undefined)?(root.focus?"#FFFFFF":"#F0F0F0"):(root.focus?backgroundFocusColor:backgroundColor)

            border.color: critical?"#EE637F":(root.focus?"#7BB6C3":(root.hovered?"#7B7BB6C3":"#F0F0F0"))
