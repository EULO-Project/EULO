...
Controls_1.TextArea
{
    ...
    style: Controls_Style_1.TextAreaStyle {
        ...
        backgroundColor:readOnly?"#F0F0F0":(root.backgroundColor === "" ? (root.focus?"#FFFFFF":"#F0F0F0"): root.backgroundColor)


        frame: Rectangle
        {
            radius:2
            color:critical?"#EE637F":(root.focus?"#7BB6C3":(root.hovered?"#7B7BB6C3":"#F0F0F0"))
