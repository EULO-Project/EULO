...
//![0]
TrafficGraphWidget::TrafficGraphWidget(QQuickItem *parent)
...
QString TrafficGraphWidget::name() const
{
    return m_name;
}

void TrafficGraphWidget::setName(const QString &name)
{
    m_name = name;
}
...
QColor TrafficGraphWidget::color() const
{
    return m_color;
}

void TrafficGraphWidget::setColor(const QColor &color)
{
    m_color = color;
}

//![1]
void TrafficGraphWidget::paint(QPainter *painter)
{
