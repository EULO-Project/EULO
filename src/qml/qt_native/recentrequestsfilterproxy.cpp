...
void RecentRequestsFilterProxy::newRequest(const QString &label, QString address,const QString &message,const QString &amountStr)
{
    ...
    BitcoinUnits::parse(walletModel->getOptionsModel()->getDisplayUnit(), amountStr, &amount);
