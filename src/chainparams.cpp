...
public:
    CMainParams()
    {
        ...
        nDefaultPort = 58802;
        bnProofOfWorkLimit = ~uint256(0) >> 8; // ULO starting difficulty is 1 / 2^12
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 20; // EULO: 1 day
        nTargetSpacing = 1 * 20;  // EULO: 1 minute
        nMaturity = 100;
         ...
         *   vMerkleTree: e0028e
         */
        const char* pszTimestamp = "President Trump bans deals in Venezuela's crypto-currency, 19 March 2018, BBC NEWS.";
        CMutableTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 521142256 << CScriptNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 250 * COIN;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("045ae4d4f02577391b20229d5a934fb579ab31defb2b2edc8b14401f640eb20eae7a6e127f6e3b4230f6d62b03e77ce8467bfcee2f239f3e9bdb6f364dcdd11a49") << OP_CHECKSIG;
        genesis.vtx.push_back(txNew);
        genesis.hashPrevBlock = 0;
        genesis.hashMerkleRoot = genesis.BuildMerkleTree();
        genesis.nVersion = 1;
        genesis.nTime = 1521556903;
        genesis.nBits = 0x1f0ffff0;
        genesis.nNonce = 975;

        hashGenesisBlock = genesis.GetHash();
        assert(hashGenesisBlock == uint256("0x000d9ebc3a2b0189ea258e85e504b80255530f7465bf7108fd9bded50d4fbe03"));
