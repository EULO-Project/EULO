...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Eulo Core eulo-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  eulo-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded eulo transaction") + "\n" +
                               "  eulo-tx [options] -create [commands]   " + _("Create hex-encoded eulo transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded eulo transaction
