...
RESOURCES += src/qt/eulo.qrc src/qt/eulo_locale.qrc

TRANSLATIONS += src/qt/locale/eulo_bg.ts \
                src/qt/locale/eulo_de.ts \
                src/qt/locale/eulo_en.ts \
                src/qt/locale/eulo_es.ts \
                src/qt/locale/eulo_fi.ts \
                src/qt/locale/eulo_fr.ts \
                src/qt/locale/eulo_it.ts \
                src/qt/locale/eulo_ja.ts \
                src/qt/locale/eulo_pl.ts \
                src/qt/locale/eulo_pt.ts \
                src/qt/locale/eulo_ru.ts \
                src/qt/locale/eulo_sk.ts \
                src/qt/locale/eulo_sv.ts \
                src/qt/locale/eulo_vi.ts \
                src/qt/locale/eulo_zh_CN.ts \
                src/qt/locale/eulo_zh_TW.ts
